...
$query=mysqli_query($con,"DELETE FROM pasien WHERE idpasien='$id_user'")or die(mysqli_error());
$query=mysqli_query($con,"DELETE FROM analisa_hasil WHERE idpasien='$id_user'")or die(mysqli_error());
if($query){
